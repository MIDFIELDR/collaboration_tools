...
## 2019 JEE [@Lord+Ohland+Layton+Camacho:2019]

All images `r sym("copyright")` 2019 Journal of Engineering Education. 
...
## 2011 JEE [@Ohland+Brawner+Camacho+others:2011]. 

All images `r sym("copyright")` 2011 Journal of Engineering Education. 
...
- The number of men (open circles) and women (filled circles) at a particular institution who matriculate in engineering and persist to the eighth semester (horizontal position) and the number of those students who subsequently graduate in engineering within six years (vertical position). The regression lines indicate the relationship between the two numbers for men and women separately. The lack of distinction between the regression lines indicates that there is no aggregate gender difference.
- data (link) placeholder
...
## 2009 JWMSE [@Lord+Camacho+Layton+others:2009]. 

All images `r sym("copyright")` 2009 Journal of Women and Minorities in Science and Engineering
...
## 2008 JEE [@Ohland+Sheppard+Lichtenstein+others:2008]. 

All images `r sym("copyright")` 2008 Journal of Engineering Education. 
