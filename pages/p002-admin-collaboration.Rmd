...
Typically, two authors may be working on different files in the project at the same time. To merge one's recent work with a co-author's work, we use the git functions:
...
Click on *Commit*. In the dialog box, type a short description of the changes. 
